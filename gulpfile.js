...
var demo_config = ['dom/example','dom/default','dom/default2','dom/demo_with_navigator','dom/slide_with_btn','dom/vertical_slide','dom/with-plugins-dot-button','dom/with-plugin-zoom','picture/default','picture/picture_with_button','picture/picture_with_dots','picture/zoom','picture/card','effect/card','effect/depth','effect/fade','effect/flip','effect/flow','effect/rotate','effect/yrks'];
